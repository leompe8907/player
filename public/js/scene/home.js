    ...
    playContent: function (type, id, url, item, reset) {
      ...
      if (autoplay) {
        ...
        if (nbPlayer.isFullscreen()) {
          ...
          if (this.firstLaunch && CONFIG.app.brand == "fotelka") {
            nbPlayer.requestFullscreen();
          }
        }
      } else {
      ...
      this.nbPlayerRetryTimeout = setTimeout(function () {
        ...
        if (self.playbackMetadata.type == "service") {
          ...
          */
          ...
          self.playContent(self.playbackMetadata.type, self.playbackMetadata.id, self.playbackMetadata.url, self.playbackMetadata.item, false);
          //nbPlayer.$player.play();
    ...
    checkParentalControl: function (type, id, url, item, reset, forceFullscreen) {
      ...
      if (requirePin) {
        ...
        ParentalControlDlg.show($container, this.$lastFocused,  function() {
          self.playContent(type, id, url, item, reset);
        }, null);
      } else {
